...
/*   Updated: 2025/06/12 17:46:10 by pedmonte         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define STEP_SIZE 1
# define FOV_ANGLE 60
# define FOV_WIDTH 1280
# define FOV_HEIGHT 960
...
float		calc_q_three(double angle, t_player *player,
				int **map, t_xypos *pos);
float		calc_q_four(double angle, t_player *player,
				int **map, t_xypos *pos);
float		calc_notables(double angle,
				t_player *player, int **map, t_xypos *pos);
